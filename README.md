...
3. > Connect-PnPOnline -Url "https://contoso.sharepoint.com/sites/Site" -ClientId "#" -Tenant "#" -Interactive

 ### Hide navigation bar (add action)
 > Add-PnPCustomAction -Name "NavHider" -Title "NavHider" -Location "ClientSideExtension.ApplicationCustomizer" -ClientSideComponentId "#" -ClientSideComponentProperties '{"hideOnHomeOnly": true, "extraHidePaths": []}' -Scope Web
